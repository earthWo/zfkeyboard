...
public class ZFKeyboardView extends View implements View.OnClickListener {
    ...
    private PopKeyboardView mMiniKeyboard;
    ...
    public ZFKeyboardView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public ZFKeyboardView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public ZFKeyboardView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
...
//                key.popupResId != 0 ? LONG_PRESSABLE_STATE_SET : EMPTY_STATE_SET);
    ...
    public boolean onTouchEvent(MotionEvent me) {
        ...
        if(me.getAction()==MotionEvent.ACTION_UP&&mMiniKeyboardOnScreen){
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_CANCEL:
                ...
                if(mMiniKeyboard!=null&&mMiniKeyboardOnScreen) {
                    Key key = mMiniKeyboard.getKeyboard().getKeys().get(0);
                    mKeyboardActionListener.onKey(key.codes[0], key.codes);
                    mKeyboardActionListener.onRelease(key.codes[0]);
                }
                break;
            default:
                break;
